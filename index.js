...
//✅》Level-System + Registering user & guild
client.on('messageCreate', message => {
  ...
  localDB.set(`${message.author.id}_nickname`, message.author.tag)
  localDB.set(`${message.author.id}_avatar`, message.member.displayAvatarURL())
  localDB.set(`${message.guild.id}_guildName`, message.guild.name)
  localDB.set(`${message.guild.id}_guildImage`, message.guild.iconURL({ format: 'png', dynamic: true, size: 1024 }))
})
...
var guildsRouter = require('./routes/guilds.js')
var formsRouter = require('./routes/forms.js')
