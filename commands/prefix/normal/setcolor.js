...
module.exports.run = async (client, message, args, prefix, color, config) => {
  ...
  .addField(`👍 | Observação:`, `<a:HYseta1:756119648654852106> O Bot Aceita Apenas Cores Em HEX! Ex: #ce3700`);
  ...
  fs.writeFile("./commands/prefix/database/colors.json", JSON.stringify(colors), (err) => {
