...
module.exports.run = async (client, message, args, prefix, color, config) => {
  ...
  if(member) {
    ...
    .setDescription(`> XP nesse servidor: **${serverpoint1s * 3}**
  
    > XP global: **${globalpoint1s * 3}**`)
    .setColor(color)
  ...
  if(!member) {
    ...
    .setDescription(`> Pontos nesse servidor: **${serverpoints * 3}**
  
    > Pontos globais: **${globalpoints * 3}**`)
    .setColor(color)
